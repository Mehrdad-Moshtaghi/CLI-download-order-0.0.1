...
def rfc3339(Udate):
	...
	RFC3339_date=pyrfc3339.generate(date_dt.replace(tzinfo=pytz.utc))
	return(RFC3339_date)
...
def Online_Readme():
	...
	"""	
    webbrowser.open("https://github.com/Mehrdad-Moshtaghi/CLI-download-order-0.0.1")
